...
import { Loader, LogIn, Pencil, BadgeCheck, BadgeX } from "lucide-react";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-black">{t('Nom')}</FormLabel>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-black">{t('Prenom')}</FormLabel>
              <FormControl className="text-black">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="col-span-2">
              <FormLabel className="block text-black">{t('N° de téléphone')}</FormLabel>
